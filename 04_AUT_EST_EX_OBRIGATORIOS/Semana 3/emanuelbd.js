...
app.use(express.static("../template_aluno"));
...
app.post('/userinsert', urlencodedParser, (req, res) => {
	...
	sql = "INSERT INTO tbUser (userId, title, id, completed) VALUES ('" + req.body.userId + "', '" + req.body.title + "', '" + req.body.id +"','" + req.body.completed +"')";
	var db = new sqlite3.Database(DBPATH); // Abre o banco
	db.run(sql, [],  err => {
		if (err) {
		    throw err;
